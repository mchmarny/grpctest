...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82, 0xf3, 0x8d, 0x82, 0xb8, 0x58, 0x40, 0x4a, 0x85, 0xbc, 0xb8,
	0x38, 0x82, 0x13, 0x2b, 0x3d, 0x52, 0x73, 0x72, 0xf2, 0x85, 0xf8, 0xf5, 0xca, 0x0c, 0xf5, 0x90,
	0x0c, 0x90, 0x42, 0x17, 0x50, 0x92, 0x69, 0xba, 0xfc, 0x64, 0x32, 0x93, 0x98, 0x90, 0x88, 0x7e,
	0x99, 0xa1, 0x7e, 0x06, 0x48, 0x93, 0x7e, 0x35, 0xcc, 0xc8, 0xda, 0x24, 0x36, 0xb0, 0x2b, 0x8c,
	0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x3e, 0x05, 0xc8, 0x38, 0xb8, 0x00, 0x00, 0x00,
}
...
func (c *pingClient) SayHello(ctx context.Context, in *PingMessage, opts ...grpc.CallOption) (*PingMessage, error) {
	out := new(PingMessage)
	err := c.cc.Invoke(ctx, "/v1.Ping/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
